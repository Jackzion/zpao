...
const routes = [
    ...
    { path: '/user/register', component: UserRegisPage },
    ...
    { path: '/chat', title: '聊天室', component: ChatRoom },
    { path: '/user/myfriends', title: '我的好友', component: MyFriendsPage },
    { path: '/user/nonfriends', title: '未同意好友', component: MyNonFriendsPage }
]
